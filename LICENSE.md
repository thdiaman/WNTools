Licences used by WNTools
========================
WNTools is licensed under the Apache License, Version 2.0.
Third-party libraries used include:
- MIT Java Wordnet Interface (JWI), licensed under the Creative Commons Attribution Version 3.0 Unported License
- Java WordNet::Similarity (JWS), licensed under the Java WordNet::Similarity License
...
Licence for MIT Java Wordnet Interface (JWI)
--------------------------------------------
Copyright (c) 2007-2014 Massachusetts Institute of Technology.
All rights reserved.

The following constitutes the MIT JWI License. It is identical to the 
Creative Commons Attribution Version 3.0 Unported License, which can be 
found on the web at:
...
Licence for Java WordNet::Similarity (JWS)
------------------------------------------
The Java WordNet::Similarity (JWS) is the following.
